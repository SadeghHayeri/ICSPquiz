...
array_name = &array_name[0];
                ...
                <li>
                    <p>مقدار هر یک اجرای قطعه کد بالا خواهیم مقدار هر یک از متغیرها به صورت زیر خواهد بود.
                    </p>
                    <p>
                    <pre style="direction: ltr;text-align: left;float: left;">
                            char** ptr= NULL;
                    ...
                    <p style="clear: left">
                        در قسمت نخست با توجه به اینکه *(p+1) پوینتر است و listOfChar [1] از جنس کاراکتر می‌باشد در واقع
                        آدرس خود اشاره‌گر را تغییر داده‌ایم و به قسمتی از حافظه که در دسترس ما نیست اشاره می‌کند.
                        قسمت دوم به درستی کامپایل خواهد شد اما در زمان اجرا با پیغام bus error: 10 برنامه کراش خواهد کرد
                        علت این امر آن است که list به صورت آرایه‌ای ۵ تایی از جنس char* تعریف شده است پس از مقداردهی
                        اولیه‌ی آن نمی‌توانیم اعضای آن را تغییر بدهیم
                        قسمت سوم نیز به درستی کامپایل خواهد شد اما در هنگام اجرا چون listOfChar دارای ۴ عضو است حداکثر
                        اندیس قابل دسترسی آن برابر با ۳ خواهد بود (مقادیر ۰ تا ۳) بنابراین هنگامی که می‌خواهیم به
                        listOfChar+4 دسترسی بیابیم در واقع از محدوده‌ی حافظه‌ی اختصاص داده شده به برنامه خارج گشتیم.

                        اگر بخواهیم قطعه کد c در سوال سه را به گونه‌ای تغییر دهیم که امکان تعویض کاراکتر i ام یک string
                        از مجموعه‌ای از آنها داشته باشیم. باید به صورت زیر عمل کنیم.
                    </p>
...
char ** list = {"An", "exam", "on", "Halloween", "night!!!!"};
    ...
    free(list);
                    ...
                    <p>
                        مشکل قسمت چهارم برابر نبودن جنس طرفین تساوی است. در سمت راست char** داریم و در سمت دیگر آن را با
                        char [const] می‌خواهیم مقداردهی کنیم که امکان پذیر نیست.
