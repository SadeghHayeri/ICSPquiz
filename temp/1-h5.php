...
VALUES ('".$_SESSION['id']."','".$_SERVER['REQUEST_URI']."')";
...
?>
        <div class="row">
            <div class="col-lg-12 text-center" >
                <div class="container" >
<p dir="rtl" style="text-align: justify;"><strong>"راهنمایی":</strong> برای محاسبه تفاضل نیاز به محاسبه مکمل دو عدد منفی می باشد. همچنین توجه فرمایید از آنجایی که اعداد داده شده 8 بیتی است عدد حاصل نیز در 8 بیت جای میگیرد.</p>
