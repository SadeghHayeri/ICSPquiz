<?php
  session_start();
$_SESSION['next']="1-e4.php";
$_SESSION['current_q']="1-q4";
$_SESSION['ans']=-1;
...
?>
        <div class="row">
            <div class="col-lg-12 text-center" >
              <p dir="rtl" style="text-align: justify;"><strong>سوال : </strong>مکمل 2 عدد "1011" در صورتی که عدد 8 بیتی باشد؟</p>
...
<p dir="rtl" style="text-align: justify;">توجه: در صورت نیاز به راهنمایی دکمه &quot;راهنمایی&quot; را انتخاب کنید. در صورت دانستن پاسخ سوال، گزینه مورد نظر را انتخاب و دکمه &quot;ارسال&quot; را انتخاب نمایید.</p>
              ...
              <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                <div class="radio">
                  <label><input type="radio" name="optradio" value="1">11110100</label>
              </div>
              <div class="radio">
                  <label><input type="radio" name="optradio" value="2">00000100</label>
              </div>
              <div class="radio">
                  <label><input type="radio" name="optradio" value="3">11110101</label>
              </div>
              <div class="radio">
                  <label><input type="radio" name="optradio" value="4">00000101</label>
              </div>
