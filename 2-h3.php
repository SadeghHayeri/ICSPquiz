...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12 text-center">
            <div class="container">
                <p dir="rtl" style="text-align: justify;"><strong>"راهنمایی":</strong>به محلی که هر یک از طرفین تساوی اشاره میکنند دقت کنید :)</p>

                <p dir="rtl" style="text-align: justify;">حال میتوانید با فشردن کلید بازگشت به سوال، مجددا به صورت سوال
                    برگردید.</p>
