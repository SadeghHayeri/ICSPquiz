<?php
  session_start();
$_SESSION['next']="1-e1.php";
$_SESSION['current_q']="1-q1";
$_SESSION['ans']=-1;
...
if($res=="" ) 
{
echo "لطفا یکی از گزینه ها را انتخاب نمایید";
}
else if ($res=="2") {
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center" >
              <p dir="rtl" style="text-align: justify;"><strong>سوال : </strong>مکمل 2 عدد 00111001 را بدست آورید</p>
...
<p dir="rtl" style="text-align: justify;">توجه: در صورت نیاز به راهنمایی دکمه &quot;راهنمایی&quot; را انتخاب کنید. در صورت دانستن پاسخ سوال، گزینه مورد نظر را انتخاب و دکمه &quot;ارسال&quot; را انتخاب نمایید.</p>
              ...
              <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                <div class="radio">
                  <label><input type="radio" name="optradio" value="1">11100011</label>
              </div>
              <div class="radio">
                  <label><input type="radio" name="optradio" value="2">11000111</label>
              </div>
              <div class="radio">
                  <label><input type="radio" name="optradio" value="3">01000111</label>
              </div>
              <div class="radio">
                  <label><input type="radio" name="optradio" value="4">11000110</label>
              </div>
              <input type="submit" class="btn btn-info" name="ans" value="ارسال">
              <a href="1-h1.php" class="btn btn-info" role="button"> راهنمایی</a>
          </form>
