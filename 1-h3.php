...
?>
        ...
        <div class="row">
            <div class="col-lg-12 text-center" >
                <div class="container" >
<p dir="rtl" style="text-align: justify;"><strong>"راهنمایی":</strong> باید توجه داشته باشید که از انجایی که اعداد داده شده 8 بیتی می باشد عدد 0110 برابر 00000110 میباشد.</p>
