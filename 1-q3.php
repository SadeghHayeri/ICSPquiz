...
?>
        <div class="row">
            <div class="col-lg-12 text-center" >
              <p dir="rtl" style="text-align: justify;"><strong>سوال : </strong>حاصل عبارت 0110-11100111را به صورت دهدهی (Decimal) محاسبه نمایید.</p>
...
<p dir="rtl" style="text-align: justify;">توجه: در صورت نیاز به راهنمایی دکمه &quot;راهنمایی&quot; را انتخاب کنید. در صورت دانستن پاسخ سوال، گزینه مورد نظر را انتخاب و دکمه &quot;ارسال&quot; را انتخاب نمایید.</p>
              ...
              <form role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                <div class="radio">
                  <label><input type="radio" name="optradio" value="1">225</label>
              </div>
              <div class="radio">
                  <label><input type="radio" name="optradio" value="2">231</label>
              </div>
              <div class="radio">
                  <label><input type="radio" name="optradio" value="3">237</label>
              </div>
              <div class="radio">
                  <label><input type="radio" name="optradio" value="4">171</label>
              </div>
