...
?>
        ...
        <div class="row">
            <div class="col-lg-12 text-center" >
                <div class="container" >
<p dir="rtl" style="text-align: justify;"><strong>"راهنمایی":</strong> برای اينکه نمايش &nbsp;A &nbsp;) &nbsp;-A عددی مخالف صفر است) را بدانیم می&shy;بایست تمامی بيت&shy;های &nbsp;A را معکوس کرده، به بيانی مکمل یک &nbsp;آنرا بدست آورد، و سپس نمايش حاصل را با 1 جمع نماييم. نمايش بدست آمده نمايش مكمل دو A- &nbsp;مي &shy;باشد.</p>

<p dir="rtl" style="text-align: justify;">حال میتوانید با فشردن کلید بازگشت به سوال، مجددا به صورت سوال برگردید.</p>
