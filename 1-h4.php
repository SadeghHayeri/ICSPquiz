...
?>
        <div class="row">
            <div class="col-lg-12 text-center" >
                <div class="container" >
<p dir="rtl" style="text-align: justify;"><strong>"راهنمایی":</strong> از آنجایی که عدد 8 بیتی است به صورت 00001011 نوشته میشود و سپس از روش توضیح داده شده در درس مکمل 2 آن را محاسبه می نماییم.</p>
